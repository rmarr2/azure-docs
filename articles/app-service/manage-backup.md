...
* [In-app MySQL databases are automatically backed up](https://github.com/projectkudu/kudu/wiki/MySQL-in-app#is-my-database-backed-up-and-restored-along-with-site-backuprestore-feature) without any configuration. If you make manually settings for in-app MySQL databases, such as adding connection strings, the backups may not work correctly.
